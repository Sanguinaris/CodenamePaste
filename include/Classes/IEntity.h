...
// Probz to DubbleClick
// (https://github.com/DubbleClick/csgo-sdk/blob/master/csgo-sdk/sdk/Classes%20Structs/IEntity.h)
...
class ICollideable {
 public:
  ...
  virtual void WorldSpaceTriggerBounds(Utils::Vector* pVecWorldMins,
                                       Utils::Vector* pVecWorldMaxs) const = 0;
  virtual bool TestCollision(const Ray_t& ray,
                             unsigned int fContentsMask,
                             trace_t& tr) = 0;
  virtual bool TestHitboxes(const Ray_t& ray,
                            unsigned int fContentsMask,
                            trace_t& tr) = 0;
  ...
  virtual void WorldSpaceSurroundingBounds(Utils::Vector* pVecMins,
                                           Utils::Vector* pVecMaxs) = 0;
