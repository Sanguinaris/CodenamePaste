...
class HookingManager : public IManager {
	...
	friend void(__fastcall CodeNamePaste::Hooks::hkFrameStageNotify)(void*, void*, Classes::ClientFrameStage_t);
...
public:
 ...
 private:
	 ...
	 std::unique_ptr<Utils::VMTManager<CodeNamePaste::Interfaces::IBaseClientDLL>> BaseClientDll;
